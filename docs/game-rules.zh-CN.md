...
**RULE-023 — 暂停终止投票。** 对局连续暂停 60 秒后，任一在线玩家可发起持续 30 秒的终止投票，选民固定为发起瞬间在线的玩家。只有严格超过半数选民选择“继续暂停”时对局才保留，并在再次暂停 60 秒后开放下一轮；全体选民提前提交但未形成该多数，或投票到期仍未形成该多数时，对局以 `ABORTED` 中止且不判定阵营胜负。离线玩家不计入选民，发起后上线的玩家只能旁观。无论投票结果如何，单次连续暂停的硬上限为 60 分钟。
...
| 7 | 梅林、派西维尔、忠臣 ×2 | 莫甘娜、刺客、爪牙 |
| 8 | 梅林、派西维尔、忠臣 ×3 | 莫甘娜、刺客、爪牙 |
| 9 | 梅林、派西维尔、忠臣 ×4 | 莫甘娜、刺客、莫德雷德 |
| 10 | 梅林、派西维尔、忠臣 ×4 | 莫甘娜、刺客、奥伯伦、莫德雷德 |

该预设适用于 5–10 人，并严格保持第 5.1 节的阵营数量。推荐配置只决定角色牌组，不改变第 5.2 节任务人数或 `RULE-014` 的失败阈值。外部攻略资料中与本规范冲突的任务表、保护轮或 9 人阵营数量不具有裁决效力。
