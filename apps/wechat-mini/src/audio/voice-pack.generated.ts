...
export const VOICE_PACK_ENTRIES = {
  'game.role.reveal': {
    ...
    source: '/assets/audio/zh-CN-v1/game-role-reveal.mp3',
  },
  'game.team.proposal': {
    ...
    source: '/assets/audio/zh-CN-v1/game-team-proposal.mp3',
  },
  'game.team.vote': {
    ...
    source: '/assets/audio/zh-CN-v1/game-team-vote.mp3',
  },
  'game.team.approved': {
    ...
    source: '/assets/audio/zh-CN-v1/game-team-approved.mp3',
  },
  'game.team.rejected': {
    ...
    source: '/assets/audio/zh-CN-v1/game-team-rejected.mp3',
  },
  'game.quest.submission': {
    ...
    source: '/assets/audio/zh-CN-v1/game-quest-submission.mp3',
  },
  'game.quest.success': {
    subtitle: '本次任务成功。',
    subtitleSha256:
    ...
    source: '/assets/audio/zh-CN-v1/game-quest-success.mp3',
  },
  'game.quest.failure': {
    subtitle: '本次任务失败。',
    subtitleSha256:
    ...
    source: '/assets/audio/zh-CN-v1/game-quest-failure.mp3',
  },
  'game.assassination': {
    ...
    source: '/assets/audio/zh-CN-v1/game-assassination.mp3',
  },
  'game.good.wins': {
    subtitle: '善方获得最终胜利。',
    subtitleSha256:
    ...
    source: '/assets/audio/zh-CN-v1/game-good-wins.mp3',
  },
  'game.evil.wins': {
    subtitle: '邪恶方获得最终胜利。',
    subtitleSha256:
    ...
    source: '/assets/audio/zh-CN-v1/game-evil-wins.mp3',
  },
  'game.aborted': {
    ...
    source: '/assets/audio/zh-CN-v1/game-aborted.mp3',
  },
} as const;
